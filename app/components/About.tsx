        ...
        <div className='relative pt-[120px] md:px-20 px-2'>
            ...
            >
                <div className='grid items-center lg:grid-cols-2 gap-6 md:gap-10'>
                    <div className='text-yellow'>
                        ...
                        <div className='mt-4'>
                            <span className='text-sm md:text-lg xl:text-xl flex flex-col font-montserrat gap-4 md:gap-7'>
            ...
            >
                <div className='absolute inset-0 flex justify-center items-center'>
                    <div className='w-full h-full md:w-[600px] md:h-[600px] bg-gradient-radial from-[#FF3E02] via-[#F9A503] to-transparent rounded-full opacity-50'></div>
                </div>
                ...
                <div className='relative h-[200px] md:h-[500px] bg-yellow mt-3 rounded-xl'>
